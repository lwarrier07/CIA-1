                         ...
                         def bookingportal():
                              ...
                              if a==[]:
                                    ...
                                    def data():
                                            ...
                                            Label(root5,text="Ticket Details",font=("Sitka Subheading Semibold",17),fg="goldenrod",width=46).grid(row=1,column=0,columnspan=4)
                                            Label(root5,text="Passenger Name",font=("Century Schoolbook",14),fg="goldenrod").grid(row=2,column=1)
                                            Label(root5,text=name.get(),font=("Century Schoolbook",14),fg="goldenrod").grid(row=2,column=2)
                                            Label(root5,text="Age",font=("Century Schoolbook",14),fg="goldenrod").grid(row=3,column=1)
                                            Label(root5,text=age.get(),font=("Century Schoolbook",14),fg="goldenrod").grid(row=3,column=2)
                                            Label(root5,text="Gender",font=("Century Schoolbook",14),fg="goldenrod").grid(row=4,column=1)
                                            if(a.get()==0):
                                                    Label(root5,text="Male",font=("Century Schoolbook",14),fg="goldenrod").grid(row=4,column=2)
                                            else:
                                                    Label(root5,text="Female",font=("Century Schoolbook",14),fg="goldenrod").grid(row=4,column=2)
                                            Label(root5,text="Class",font=("Century Schoolbook",14),fg="goldenrod").grid(row=5,column=1)
                                            Label(root5,text=v.get(),font=("Century Schoolbook",14),fg="goldenrod").grid(row=5,column=2)
                                            Label(root5,text="Date",font=("Century Schoolbook",14),fg="goldenrod").grid(row=6,column=1)
                                            Label(root5,text=date.get(),font=("Century Schoolbook",14),fg="goldenrod").grid(row=6,column=2)
                                            Label(root5,text="Additional Passenger Details",font=("Baskerville Old Face",17),fg="goldenrod",width=46).grid(row=7,column=0,columnspan=4)
                                            Label(root5,text="Passenger Name",font=("Century Schoolbook",14),fg="goldenrod").grid(row=8,column=1)
                                            Label(root5,text=name1.get(),font=("Century Schoolbook",14),fg="goldenrod").grid(row=8,column=2)
                                            Label(root5,text="Class",font=("Century Schoolbook",14),fg="goldenrod").grid(row=9,column=1)
                                            Label(root5,text=v1.get(),font=("Century Schoolbook",14),fg="goldenrod").grid(row=9,column=2)
                                            Label(root5,text="Passenger Name",font=("Century Schoolbook",14),fg="goldenrod").grid(row=10,column=1)
                                            Label(root5,text=name2.get(),font=("Century Schoolbook",14),fg="goldenrod").grid(row=10,column=2)
                                            Label(root5,text="Class",font=("Century Schoolbook",14),fg="goldenrod").grid(row=11,column=1)
                                            Label(root5,text=v2.get(),font=("Century Schoolbook",14),fg="goldenrod").grid(row=11,column=2)
                                            Label(root5,text="Passenger Name",font=("Century Schoolbook",14),fg="goldenrod").grid(row=12,column=1)
                                            Label(root5,text=name3.get(),font=("Century Schoolbook",14),fg="goldenrod").grid(row=12,column=2)
                                            Label(root5,text="Class",font=("Century Schoolbook",14),fg="goldenrod").grid(row=13,column=1)
                                            Label(root5,text=v3.get(),font=("Century Schoolbook",14),fg="goldenrod").grid(row=13,column=2)
                                            Label(root5,text="Amount Per Passsenger",font=("Baskerville Old Face",17),fg="goldenrod",width=46).grid(row=14,column=0,columnspan=4)
